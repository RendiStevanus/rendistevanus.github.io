...
!(function (e, t) {
  ...
  const a = (e) => {
    ...
    o = "ti-cursor",
    s = { started: !1, completed: !1, frozen: !1, destroyed: !1 },
    l = {
      breakLines: !0,
      cursor: { autoPause: !0, autoPauseDelay: 500, animation: { frames: [0, 0, 1].map((e) => ({ opacity: e })), options: { iterations: 1 / 0, easing: "steps(2, start)", fill: "forwards" } } },
      cursorChar: "|",
      cursorSpeed: 1e3,
      deleteSpeed: null,
      html: !0,
  ...
  function u(e, t = !1, n = !1) {
    let r,
      ...
      a = document.createTreeWalker(e, NodeFilter.SHOW_ALL, {
        acceptNode: (e) => {
          if (i && n) {
            if (e.classList?.contains(o)) return NodeFilter.FILTER_ACCEPT;
      ...
      s = [];
    for (; (r = a.nextNode()); ) r.originalParent || (r.originalParent = r.parentNode), s.push(r);
  ...
  let v = { "font-family": "", "font-weight": "", "font-size": "", "font-style": "", "line-height": "", color: "", transform: "translateX(-.125em)" };
  ...
  let S = (e) =>
    ...
    D = async ({ index: e, queueItems: t, wait: n, cursor: r, cursorOptions: i }) => {
      ...
      let d,
        f = N(r);
      return (
        f && (d = { ...f.effect.getComputedTiming(), delay: c ? i.autoPauseDelay : 0 }),
        await n(async () => {
          f && c && f.cancel(),
            await S(() => {
              C(a);
        ...
        await (({ cursor: e, options: t, cursorOptions: n }) => {
          ...
          let a = L({ cursor: e, frames: n.animation.frames, options: t });
  ...
  return function (e, r = {}) {
    let S = async (e, t, n = !1) => {
      ...
      N = (e, t) => D({ index: e, queueItems: t, wait: S, cursor: ee, cursorOptions: G.cursor }),
      C = (e) =>
        ((e, t) => {
          if (!e) return;
          let n = e.parentNode;
      ...
      H = () => W ?? U,
      O = (e = {}) => [{ func: () => B(e) }, { func: () => B(G) }],
      F = (e) => {
        let t = G.nextStringDelay;
        Y.add([{ delay: t[0] }, ...e, { delay: t[1] }]);
      },
      k = async () => {
        if ((!I() && ee && V.appendChild(ee), Z)) {
          ...
          L({ frames: t, cursor: ee, options: { duration: G.cursorSpeed, ...n } });
        }
      },
      R = () => {
        ...
        e.forEach((t, n) => {
          ...
          let r = G.breakLines ? [{ func: () => z(d("BR")), typeable: !0 }] : E({ func: j, delay: M(1) }, Y.getTypeable().length);
          F(r);
        });
      },
      $ = async (e = !0) => {
        ...
        try {
          ...
          if (!e) return this;
          if (((X.completed = !0), await G.afterComplete(this), !G.loop)) throw "";
          let r = G.loopDelay;
          S(async () => {
            await (async (e) => {
              let t = H();
              t && (await q({ value: t }));
              let n = x().map((e) => [Symbol(), { func: j, delay: M(1), deletable: !0, shouldPauseCursor: () => !0 }]);
              for (let r = 0; r < n.length; r++) await N(r, n);
              Y.reset(), Y.set(0, { delay: e });
            })(r[0]),
              $();
          }, r[1]);
        } catch (n) {}
      ...
      z = (e) =>
        ((e, t) => {
          if (m(e)) return void (e.value = `${e.value}${t.textContent}`);
          t.innerHTML = "";
    ...
    (this.break = function (e) {
      return A({ func: () => z(d("BR")), typeable: !0 }, e);
    }),
      (this.delete = function (e = null, t = {}) {
        ...
        let n = O(t),
          ...
          { instant: i, to: a } = t,
          o = Y.getTypeable(),
          s = null === r ? o.length : b(r) ? r : P({ queueItems: o, selector: r, cursorPosition: H(), to: a });
        return A([n[0], ...E({ func: j, delay: i ? 0 : M(1), deletable: !0 }, s), n[1]], t);
      }),
      ...
      (this.exec = function (e, t = {}) {
        let n = O(t);
        return A([n[0], { func: () => e(this) }, n[1]], t);
      }),
      (this.move = function (e, t = {}) {
        e = g(e);
        let n = O(t),
          { instant: r, to: i } = t,
          a = P({ queueItems: Y.getTypeable(), selector: null === e ? "" : e, to: i, cursorPosition: H() }),
          o = a < 0 ? -1 : 1;
        return (W = H() + a), A([n[0], ...E({ func: () => q(o), delay: r ? 0 : M(), cursorable: !0 }, Math.abs(a)), n[1]], t);
      }),
      (this.options = function (e, t = {}) {
        return (e = g(e)), B(e), A({}, t);
      }),
      (this.pause = function (e, t = {}) {
        return A({ delay: g(e) }, t);
      }),
      (this.type = function (e, t = {}) {
        ...
        let { instant: n } = t,
          r = O(t),
          i = c(e, G.html).map((e) => {
            return { func: () => z(e), char: e, delay: n || ((t = e), /<(.+)>(.*?)<\/(.+)>/.test(t.outerHTML)) ? 0 : M(), typeable: e.nodeType === Node.TEXT_NODE };
            var t;
          }),
          a = [r[0], { func: async () => await G.beforeString(e, this) }, ...i, { func: async () => await G.afterString(e, this) }, r[1]];
        return A(a, t);
      }),
      (this.is = function (e) {
        return X[e];
      ...
      (this.destroy = function (e = !0) {
        J.forEach(clearTimeout), (J = []), g(e) && ee && C(ee), (X.destroyed = !0);
      }),
      ...
      (this.reset = function (e) {
        !this.is("destroyed") && this.destroy(), e ? (Y.wipe(), e(this)) : Y.reset(), (U = 0);
        for (let t in X) X[t] = !1;
    ...
    let G = T(l, r);
    G = T(G, { html: !I() && G.html, nextStringDelay: h(G.nextStringDelay), loopDelay: h(G.loopDelay) });
    let K = Math.random().toString().substring(2, 9),
      Y = (function (e) {
        let n = function (e) {
            return t(e).forEach((e) => a.set(Symbol(e.char?.innerText), r({ ...e }))), this;
          },
          r = (e) => (
    ...
    (V.dataset.typeitId = K), f("[data-typeit-id]:before {content: '.'; display: inline-block; width: 0; visibility: hidden;}");
    let Z = !!G.cursor && !I(),
      ee = (() => {
        if (I()) return;
        let e = d("span");
    ...
    (G.strings = ((e) => {
      ...
      return t
        ? ((V.innerHTML = ""),
          G.startDelete
            ? ((V.innerHTML = t), i(V), F(E({ func: j, delay: M(1), deletable: !0 }, x().length)), e)
            : t
                .replace(/<!--(.+?)-->/g, "")
                .trim()
                .split(/<br(?:\s*?)(?:\/)?>/)
